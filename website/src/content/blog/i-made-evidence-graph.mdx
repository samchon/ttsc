...
The [complete examples](https://ttsc.dev/docs/evidence/examples) show all thirteen backend and frontend claim-reference pairs and the real benchmark configuration behind them.
...
- [Adoption](https://ttsc.dev/docs/evidence/adoption)
- [Complete backend, frontend, and novel examples](https://ttsc.dev/docs/evidence/examples)
