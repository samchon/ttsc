...
The [graph patterns](https://ttsc.dev/docs/evidence/patterns) show all thirteen backend and frontend claim-reference pairs and the real benchmark configuration behind them.
...
- [Backend, frontend, and novel graph patterns](https://ttsc.dev/docs/evidence/patterns)
