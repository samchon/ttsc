...
Each address is the path a consumer would actually write to reach the member, which is why a constructor parameter property takes the instance form of the field it declares. [Claims and References](/docs/evidence/claims#typescript-kinds) covers which members are selected and why the two class forms differ.
