...
A class merged with a same-named namespace is one `type` unit reported from the class, because TypeScript refuses a namespace written before the class it merges with.
