...
For publishing this repository's `ttsc`, `@ttsc/*`, and platform packages, see [Workspace Release](/docs/plugin-development/reference/workspace-release).
...
→ [Local development](/docs/plugin-development/authoring/local-dev)
