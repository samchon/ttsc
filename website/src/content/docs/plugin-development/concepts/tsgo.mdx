...
For a small source-AST transform, start with [Getting Started](/docs/plugin-development/authoring/getting-started). For the four shipped examples, read [Reference Plugins](/docs/plugin-development/reference/reference-plugins).
...
`v0.0.0` is intentional. The modules are supplied by `ttsc`'s generated `go.work` overlay at build time. For local editor support, create your own `go.work`; see [Local Development](/docs/plugin-development/authoring/local-dev).
...
- [`packages/lint/linthost/host.go`](https://github.com/samchon/ttsc/tree/master/packages/lint/linthost/host.go) - production-grade Program loader.
- [`tests/projects/go-source-plugin-checker/go-plugin/main.go`](https://github.com/samchon/ttsc/tree/master/tests/projects/go-source-plugin-checker/go-plugin/main.go) - compact bootstrap fixture.
...
`@ttsc/lint` uses this shape and dispatches rules by `node.Kind`; see [`packages/lint/linthost/engine.go`](https://github.com/samchon/ttsc/tree/master/packages/lint/linthost/engine.go).
...
- [`packages/ttsc/shim/diagnosticwriter/lint.go`](https://github.com/samchon/ttsc/tree/master/packages/ttsc/shim/diagnosticwriter/lint.go)
...
1. [`packages/banner`](https://github.com/samchon/ttsc/tree/master/packages/banner/) - source JSDoc preamble insertion.
2. [`packages/ttsc/utility/host.go`](https://github.com/samchon/ttsc/tree/master/packages/ttsc/utility/host.go) - first-party banner, strip, and paths transform host.
