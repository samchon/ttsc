...
- [Plugin Development · TS-Go concepts](/docs/plugin-development/concepts/tsgo) — Program / Checker / VFS.
- [Plugin Development · Authoring](/docs/plugin-development/authoring) — the 5-step authoring walkthrough.
- [Plugin Development · Reference](/docs/plugin-development/reference) — architecture and pitfalls.
