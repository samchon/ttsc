...
- pnpm local dev layout, fixed in [Local Development](/docs/plugin-development/authoring/local-dev).
...
- [Reference plugins](/docs/plugin-development/reference/reference-plugins) — first-party plugins as worked examples.
- [Pitfalls](/docs/plugin-development/reference/pitfalls) — failure modes specific to plugin authoring.
- [Plugin Protocol](/docs/plugin-development/concepts/protocol) — the wire contract.
