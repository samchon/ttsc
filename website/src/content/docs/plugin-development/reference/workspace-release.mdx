...
This page is for maintainers working on this repository, not for third-party plugin packages. For plugin package publishing, use [Publishing Plugins](/docs/plugin-development/authoring/publishing).
...
- [Publishing Plugins](/docs/plugin-development/authoring/publishing) — for third-party plugin packages.
- [Architecture](/docs/plugin-development/reference/architecture) — what the workspace ships.
- [Reference plugins](/docs/plugin-development/reference/reference-plugins) — the in-repo plugins this release pipeline produces.
