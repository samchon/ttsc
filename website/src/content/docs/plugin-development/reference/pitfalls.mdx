...
For local editor support, also configure `go.work`; see [Local Development](/docs/plugin-development/authoring/local-dev).
...
- [Architecture](/docs/plugin-development/reference/architecture) — what the build pipeline does so you can predict failure modes.
- [Reference plugins](/docs/plugin-development/reference/reference-plugins) — worked examples of the patterns that work.
- [Authoring · Local development](/docs/plugin-development/authoring/local-dev) — fast iteration without `ttsc`.
