...
- [Graph Patterns](/docs/evidence/patterns): the backend, frontend, principles, and novel graphs that shipped.
- [Claims and References](/docs/evidence/claims): the full configuration surface.
- [Evidence Tags](/docs/evidence/tags): the grammar your agent will be writing.
- [Rules](/docs/evidence/rules): all five rules and their options.
- [Adoption](/docs/evidence/adoption): the order to enable claims in on an existing codebase.
- [Troubleshooting](/docs/evidence/troubleshooting): what each diagnostic means and the repair it names.
