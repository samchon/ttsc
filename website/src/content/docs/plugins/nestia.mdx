...
The full pipeline runs everywhere `ttsc` runs — `ttsc --emit`, `ttsx`, the VS Code extension, every [`@ttsc/unplugin`](/docs/ttsc/bundler) bundler adapter. One install; the transforms fire wherever NestJS code is compiled.
