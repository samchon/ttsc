...
- [Tools](/docs/graph/tools): what `query_exports`, `query_nodes`, `query_files`, and `query_diagnostics` return, the diagnostic sources, the edge kinds, and the current scope.
