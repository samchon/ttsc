...
The plugin binary cache lives at `node_modules/.ttsc/` by default. Override with `--cache-dir`. Safe to delete at any time (`ttsc clean`) — binaries get rebuilt on next use.
