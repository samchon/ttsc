...
- `jsx-a11y/img-redundant-alt`: Reject redundant words such as _image_, _photo_, or _picture_ inside the `alt` attribute of an `<img>`. The role already conveys "this is an image".
