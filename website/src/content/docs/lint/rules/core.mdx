...
By default, reject function declarations in nested blocks when the surrounding script is sloppy and legacy function-hoisting semantics apply. Strict scripts, ECMAScript modules, and class code use ES2015 block-scoped functions and are allowed by default.
