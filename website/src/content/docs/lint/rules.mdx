...
The format rules (`format/*`) cover Prettier's territory. They live on their own page — [Format rules](/docs/lint/format).
...
- [Format rules](/docs/lint/format) — the `format/*` subset (including `format/print-width`).
- [`ttsc fix` & `ttsc format`](/docs/lint/fix) — the autofix workflow.
