...
For publishing this repository's `ttsc`, `@ttsc/*`, and platform packages, see [Workspace Release](/docs/development/reference/workspace-release).
...
→ [Local development](/docs/development/authoring/local-dev)
