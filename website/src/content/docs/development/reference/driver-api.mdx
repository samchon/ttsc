...
- `UseCaseSensitiveFileNames` is the case policy the compiler matched the project with, taken from the filesystem its executable lives on; hosts decide project membership under it.
