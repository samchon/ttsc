...
For local editor support, also configure `go.work`; see [Local Development](/docs/development/authoring/local-dev).
...
- [Authoring · Local development](/docs/development/authoring/local-dev) — fast iteration without `ttsc`.
