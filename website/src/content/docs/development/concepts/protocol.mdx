...
- [Plugin Development · TS-Go concepts](/docs/development/concepts/tsgo) — Program / Checker / VFS.
- [Plugin Development · Authoring](/docs/development/authoring) — the 5-step authoring walkthrough.
- [Plugin Development · Reference](/docs/development/reference) — architecture and pitfalls.
