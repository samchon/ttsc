...
Both host-owned lanes declare completeness themselves, and the rule they declare it under is the one every producer needs in order to declare anything at all.
