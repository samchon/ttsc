...
<Tabs items={[<code>ITtscGraphApplication.ts</code>, <code>ITtscGraphTour.ts</code>, <code>ITtscGraphNext.ts</code>, <code>instructions.ts</code>, <code>resultGuide.ts</code>]}>
  <Tabs.Tab>
