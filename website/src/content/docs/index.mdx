...
Install the VS Code extension to run your project's `ttscserver` / TypeScript-Go language server in VS Code, with live TypeScript-Go editor features plus saved-state ttsc plugin diagnostics and actions in the same editor stream:
