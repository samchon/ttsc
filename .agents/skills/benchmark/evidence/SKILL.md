...
- **[Measurement](measurement/SKILL.md)** is the benchmark's own view: how a cell is run, whether what it did still counts, and what may be published about it.
- **[Intervention](intervention/SKILL.md)** is your view as this repository's agent: what you may change, how you warn a cell, and how you recover one.
...
- `report`, `charts`, `coverage`: the tracked `benchmarks/evidence/aggregate` artifacts, their charts, and the Plain coverage composition. [aggregate.md](measurement/aggregate.md)
