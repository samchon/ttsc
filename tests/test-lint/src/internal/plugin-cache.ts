 ...
 * exercise the `@ttsc/lint` source plugin but do not assert on the build
 * itself.
 *
 ...
 * a given plugin cold-builds; the rest hit warm. That cuts roughly a dozen cold
 * `@ttsc/lint` builds (ten-plus seconds each) down to one.
 *
