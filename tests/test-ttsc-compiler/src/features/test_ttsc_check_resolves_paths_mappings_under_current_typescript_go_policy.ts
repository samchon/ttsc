import { assert, createProject, spawn, ttscBin } from "../internal/toolchain";

/**
 * Verifies ttsc check resolves paths mappings under current TypeScript-Go policy.
 *
 * This ttsc compiler toolchain scenario is isolated as one exported TypeScript feature
