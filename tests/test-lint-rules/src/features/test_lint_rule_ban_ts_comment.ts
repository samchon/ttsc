...
/**
 * Verifies the ban-ts-comment.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/ban-ts-comment.ts`.
 ...
 */
export const test_lint_rule_ban_ts_comment = (): void => {
  assertLintCase("ban-ts-comment.ts");
};
