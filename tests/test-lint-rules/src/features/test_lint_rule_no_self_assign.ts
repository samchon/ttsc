...
/**
 * Verifies the no-self-assign.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-self-assign.ts`.
 ...
 */
export const test_lint_rule_no_self_assign = (): void => {
  assertLintCase("no-self-assign.ts");
};
