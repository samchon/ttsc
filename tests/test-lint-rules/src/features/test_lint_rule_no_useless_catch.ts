...
/**
 * Verifies the no-useless-catch.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-useless-catch.ts`.
 ...
 */
export const test_lint_rule_no_useless_catch = (): void => {
  assertLintCase("no-useless-catch.ts");
};
