...
/**
 * Verifies the no-duplicate-case.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-duplicate-case.ts`.
 ...
 */
export const test_lint_rule_no_duplicate_case = (): void => {
  assertLintCase("no-duplicate-case.ts");
};
