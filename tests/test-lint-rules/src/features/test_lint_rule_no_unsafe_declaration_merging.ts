...
/**
 * Verifies the no-unsafe-declaration-merging.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-unsafe-declaration-merging.ts`.
 ...
 */
export const test_lint_rule_no_unsafe_declaration_merging = (): void => {
  assertLintCase("no-unsafe-declaration-merging.ts");
};
