...
/**
 * Verifies the no-useless-constructor.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-useless-constructor.ts`.
 ...
 */
export const test_lint_rule_no_useless_constructor = (): void => {
  assertLintCase("no-useless-constructor.ts");
};
