...
/**
 * Verifies the no-console.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-console.ts`.
 ...
 */
export const test_lint_rule_no_console = (): void => {
  assertLintCase("no-console.ts");
};
