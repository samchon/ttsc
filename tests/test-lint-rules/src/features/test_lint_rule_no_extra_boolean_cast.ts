...
/**
 * Verifies the no-extra-boolean-cast.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-extra-boolean-cast.ts`.
 ...
 */
export const test_lint_rule_no_extra_boolean_cast = (): void => {
  assertLintCase("no-extra-boolean-cast.ts");
};
