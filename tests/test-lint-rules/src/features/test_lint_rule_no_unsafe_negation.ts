...
/**
 * Verifies the no-unsafe-negation.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-unsafe-negation.ts`.
 ...
 */
export const test_lint_rule_no_unsafe_negation = (): void => {
  assertLintCase("no-unsafe-negation.ts");
};
