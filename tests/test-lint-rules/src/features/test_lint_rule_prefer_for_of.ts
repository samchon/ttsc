...
/**
 * Verifies the prefer-for-of.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/prefer-for-of.ts`.
 ...
 */
export const test_lint_rule_prefer_for_of = (): void => {
  assertLintCase("prefer-for-of.ts");
};
