...
/**
 * Verifies the no-promise-executor-return.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-promise-executor-return.ts`.
 ...
 */
export const test_lint_rule_no_promise_executor_return = (): void => {
  assertLintCase("no-promise-executor-return.ts");
};
