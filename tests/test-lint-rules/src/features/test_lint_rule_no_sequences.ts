...
/**
 * Verifies the no-sequences.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-sequences.ts`.
 ...
 */
export const test_lint_rule_no_sequences = (): void => {
  assertLintCase("no-sequences.ts");
};
