...
/**
 * Verifies the no-unnecessary-type-constraint.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-unnecessary-type-constraint.ts`.
 ...
 */
export const test_lint_rule_no_unnecessary_type_constraint = (): void => {
  assertLintCase("no-unnecessary-type-constraint.ts");
};
