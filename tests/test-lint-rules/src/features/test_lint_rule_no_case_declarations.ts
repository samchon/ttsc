...
/**
 * Verifies the no-case-declarations.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-case-declarations.ts`.
 ...
 */
export const test_lint_rule_no_case_declarations = (): void => {
  assertLintCase("no-case-declarations.ts");
};
