...
/**
 * Verifies the prefer-literal-enum-member.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/prefer-literal-enum-member.ts`.
 ...
 */
export const test_lint_rule_prefer_literal_enum_member = (): void => {
  assertLintCase("prefer-literal-enum-member.ts");
};
