...
/**
 * Verifies the no-script-url.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-script-url.ts`.
 ...
 */
export const test_lint_rule_no_script_url = (): void => {
  assertLintCase("no-script-url.ts");
};
