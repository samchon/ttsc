...
/**
 * Verifies the no-constant-condition.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-constant-condition.ts`.
 ...
 */
export const test_lint_rule_no_constant_condition = (): void => {
  assertLintCase("no-constant-condition.ts");
};
