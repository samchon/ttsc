...
/**
 * Verifies the no-non-null-asserted-optional-chain.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-non-null-asserted-optional-chain.ts`.
 ...
 */
export const test_lint_rule_no_non_null_asserted_optional_chain = (): void => {
  assertLintCase("no-non-null-asserted-optional-chain.ts");
};
