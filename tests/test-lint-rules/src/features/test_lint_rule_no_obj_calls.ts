...
/**
 * Verifies the no-obj-calls.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-obj-calls.ts`.
 ...
 */
export const test_lint_rule_no_obj_calls = (): void => {
  assertLintCase("no-obj-calls.ts");
};
