...
/**
 * Verifies the no-multi-assign.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-multi-assign.ts`.
 ...
 */
export const test_lint_rule_no_multi_assign = (): void => {
  assertLintCase("no-multi-assign.ts");
};
