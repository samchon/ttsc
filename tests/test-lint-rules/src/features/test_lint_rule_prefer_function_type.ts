...
/**
 * Verifies the prefer-function-type.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/prefer-function-type.ts`.
 ...
 */
export const test_lint_rule_prefer_function_type = (): void => {
  assertLintCase("prefer-function-type.ts");
};
