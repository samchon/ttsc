...
/**
 * Verifies the array-type.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/array-type.ts`.
 ...
 */
export const test_lint_rule_array_type = (): void => {
  assertLintCase("array-type.ts");
};
