...
/**
 * Verifies the no-multi-str.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-multi-str.ts`.
 ...
 */
export const test_lint_rule_no_multi_str = (): void => {
  assertLintCase("no-multi-str.ts");
};
