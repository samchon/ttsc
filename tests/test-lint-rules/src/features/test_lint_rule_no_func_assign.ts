...
/**
 * Verifies the no-func-assign.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-func-assign.ts`.
 ...
 */
export const test_lint_rule_no_func_assign = (): void => {
  assertLintCase("no-func-assign.ts");
};
