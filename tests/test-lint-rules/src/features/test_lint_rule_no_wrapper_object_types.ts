...
/**
 * Verifies the no-wrapper-object-types.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-wrapper-object-types.ts`.
 ...
 */
export const test_lint_rule_no_wrapper_object_types = (): void => {
  assertLintCase("no-wrapper-object-types.ts");
};
