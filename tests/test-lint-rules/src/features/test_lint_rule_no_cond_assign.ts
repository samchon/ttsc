...
/**
 * Verifies the no-cond-assign.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-cond-assign.ts`.
 ...
 */
export const test_lint_rule_no_cond_assign = (): void => {
  assertLintCase("no-cond-assign.ts");
};
