...
/**
 * Verifies the prefer-namespace-keyword.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/prefer-namespace-keyword.ts`.
 ...
 */
export const test_lint_rule_prefer_namespace_keyword = (): void => {
  assertLintCase("prefer-namespace-keyword.ts");
};
