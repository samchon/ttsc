...
/**
 * Verifies the no-continue.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-continue.ts`.
 ...
 */
export const test_lint_rule_no_continue = (): void => {
  assertLintCase("no-continue.ts");
};
