...
/**
 * Verifies the no-dupe-else-if.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-dupe-else-if.ts`.
 ...
 */
export const test_lint_rule_no_dupe_else_if = (): void => {
  assertLintCase("no-dupe-else-if.ts");
};
