...
/**
 * Verifies the no-inner-declarations.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-inner-declarations.ts`.
 ...
 */
export const test_lint_rule_no_inner_declarations = (): void => {
  assertLintCase("no-inner-declarations.ts");
};
