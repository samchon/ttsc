...
/**
 * Verifies the for-direction.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/for-direction.ts`.
 ...
 */
export const test_lint_rule_for_direction = (): void => {
  assertLintCase("for-direction.ts");
};
