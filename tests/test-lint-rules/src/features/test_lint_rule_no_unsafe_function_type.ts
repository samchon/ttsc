...
/**
 * Verifies the no-unsafe-function-type.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-unsafe-function-type.ts`.
 ...
 */
export const test_lint_rule_no_unsafe_function_type = (): void => {
  assertLintCase("no-unsafe-function-type.ts");
};
