...
/**
 * Verifies the no-control-regex.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-control-regex.ts`.
 ...
 */
export const test_lint_rule_no_control_regex = (): void => {
  assertLintCase("no-control-regex.ts");
};
