...
/**
 * Verifies the no-undef-init.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-undef-init.ts`.
 ...
 */
export const test_lint_rule_no_undef_init = (): void => {
  assertLintCase("no-undef-init.ts");
};
