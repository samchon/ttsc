...
/**
 * Verifies the no-dupe-args.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-dupe-args.ts`.
 ...
 */
export const test_lint_rule_no_dupe_args = (): void => {
  assertLintCase("no-dupe-args.ts");
};
