...
/**
 * Verifies the no-unneeded-ternary.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-unneeded-ternary.ts`.
 ...
 */
export const test_lint_rule_no_unneeded_ternary = (): void => {
  assertLintCase("no-unneeded-ternary.ts");
};
