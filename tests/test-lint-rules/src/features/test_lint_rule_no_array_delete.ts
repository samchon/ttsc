...
/**
 * Verifies the no-array-delete.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-array-delete.ts`.
 ...
 */
export const test_lint_rule_no_array_delete = (): void => {
  assertLintCase("no-array-delete.ts");
};
