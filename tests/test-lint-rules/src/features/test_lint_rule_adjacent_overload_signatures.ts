...
/**
 * Verifies the adjacent-overload-signatures.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/adjacent-overload-signatures.ts`.
 ...
 */
export const test_lint_rule_adjacent_overload_signatures = (): void => {
  assertLintCase("adjacent-overload-signatures.ts");
};
