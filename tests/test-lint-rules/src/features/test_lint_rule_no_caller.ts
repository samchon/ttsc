...
/**
 * Verifies the no-caller.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-caller.ts`.
 ...
 */
export const test_lint_rule_no_caller = (): void => {
  assertLintCase("no-caller.ts");
};
