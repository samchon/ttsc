...
/**
 * Verifies the no-unused-expressions.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-unused-expressions.ts`.
 ...
 */
export const test_lint_rule_no_unused_expressions = (): void => {
  assertLintCase("no-unused-expressions.ts");
};
