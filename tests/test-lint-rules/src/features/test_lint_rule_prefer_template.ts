...
/**
 * Verifies the prefer-template.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/prefer-template.ts`.
 ...
 */
export const test_lint_rule_prefer_template = (): void => {
  assertLintCase("prefer-template.ts");
};
