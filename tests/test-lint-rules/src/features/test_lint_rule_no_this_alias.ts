...
/**
 * Verifies the no-this-alias.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-this-alias.ts`.
 ...
 */
export const test_lint_rule_no_this_alias = (): void => {
  assertLintCase("no-this-alias.ts");
};
