...
/**
 * Verifies the no-extra-bind.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-extra-bind.ts`.
 ...
 */
export const test_lint_rule_no_extra_bind = (): void => {
  assertLintCase("no-extra-bind.ts");
};
