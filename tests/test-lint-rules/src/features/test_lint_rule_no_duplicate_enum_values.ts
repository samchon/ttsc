...
/**
 * Verifies the no-duplicate-enum-values.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-duplicate-enum-values.ts`.
 ...
 */
export const test_lint_rule_no_duplicate_enum_values = (): void => {
  assertLintCase("no-duplicate-enum-values.ts");
};
