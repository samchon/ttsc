...
/**
 * Verifies the no-regex-spaces.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-regex-spaces.ts`.
 ...
 */
export const test_lint_rule_no_regex_spaces = (): void => {
  assertLintCase("no-regex-spaces.ts");
};
