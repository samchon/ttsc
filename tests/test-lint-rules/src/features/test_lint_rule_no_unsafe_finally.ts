...
/**
 * Verifies the no-unsafe-finally.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-unsafe-finally.ts`.
 ...
 */
export const test_lint_rule_no_unsafe_finally = (): void => {
  assertLintCase("no-unsafe-finally.ts");
};
