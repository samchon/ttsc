...
/**
 * Verifies the vars-on-top.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/vars-on-top.ts`.
 ...
 */
export const test_lint_rule_vars_on_top = (): void => {
  assertLintCase("vars-on-top.ts");
};
