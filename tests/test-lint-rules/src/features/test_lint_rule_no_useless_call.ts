...
/**
 * Verifies the no-useless-call.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-useless-call.ts`.
 ...
 */
export const test_lint_rule_no_useless_call = (): void => {
  assertLintCase("no-useless-call.ts");
};
