...
/**
 * Verifies the no-new-func.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-new-func.ts`.
 ...
 */
export const test_lint_rule_no_new_func = (): void => {
  assertLintCase("no-new-func.ts");
};
