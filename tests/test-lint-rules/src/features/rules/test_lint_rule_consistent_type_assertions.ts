...
/**
 * Verifies the consistent-type-assertions.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/consistent-type-assertions.ts`.
 ...
 */
export const test_lint_rule_consistent_type_assertions = (): void => {
  assertLintCase("consistent-type-assertions.ts");
};
