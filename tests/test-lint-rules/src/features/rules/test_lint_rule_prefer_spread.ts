...
/**
 * Verifies the prefer-spread.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/prefer-spread.ts`.
 ...
 */
export const test_lint_rule_prefer_spread = (): void => {
  assertLintCase("prefer-spread.ts");
};
