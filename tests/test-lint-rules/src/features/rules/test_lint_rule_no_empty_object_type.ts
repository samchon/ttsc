...
/**
 * Verifies the no-empty-object-type.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-empty-object-type.ts`.
 ...
 */
export const test_lint_rule_no_empty_object_type = (): void => {
  assertLintCase("no-empty-object-type.ts");
};
