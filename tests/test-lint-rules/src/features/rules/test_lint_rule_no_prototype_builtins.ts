...
/**
 * Verifies the no-prototype-builtins.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-prototype-builtins.ts`.
 ...
 */
export const test_lint_rule_no_prototype_builtins = (): void => {
  assertLintCase("no-prototype-builtins.ts");
};
