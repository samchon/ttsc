...
/**
 * Verifies the consistent-type-definitions.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/consistent-type-definitions.ts`.
 ...
 */
export const test_lint_rule_consistent_type_definitions = (): void => {
  assertLintCase("consistent-type-definitions.ts");
};
