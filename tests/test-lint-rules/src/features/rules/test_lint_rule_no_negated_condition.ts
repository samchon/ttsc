...
/**
 * Verifies the no-negated-condition.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-negated-condition.ts`.
 ...
 */
export const test_lint_rule_no_negated_condition = (): void => {
  assertLintCase("no-negated-condition.ts");
};
