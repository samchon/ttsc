...
/**
 * Verifies the no-useless-concat.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-useless-concat.ts`.
 ...
 */
export const test_lint_rule_no_useless_concat = (): void => {
  assertLintCase("no-useless-concat.ts");
};
