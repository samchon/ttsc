...
/**
 * Verifies the prefer-enum-initializers.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/prefer-enum-initializers.ts`.
 ...
 */
export const test_lint_rule_prefer_enum_initializers = (): void => {
  assertLintCase("prefer-enum-initializers.ts");
};
