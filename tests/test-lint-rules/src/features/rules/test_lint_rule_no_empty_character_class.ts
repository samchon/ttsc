...
/**
 * Verifies the no-empty-character-class.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-empty-character-class.ts`.
 ...
 */
export const test_lint_rule_no_empty_character_class = (): void => {
  assertLintCase("no-empty-character-class.ts");
};
