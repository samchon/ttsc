...
/**
 * Verifies the no-unused-labels.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-unused-labels.ts`.
 ...
 */
export const test_lint_rule_no_unused_labels = (): void => {
  assertLintCase("no-unused-labels.ts");
};
