...
/**
 * Verifies the no-shadow-restricted-names.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-shadow-restricted-names.ts`.
 ...
 */
export const test_lint_rule_no_shadow_restricted_names = (): void => {
  assertLintCase("no-shadow-restricted-names.ts");
};
