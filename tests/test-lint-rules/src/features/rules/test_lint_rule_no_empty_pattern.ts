...
/**
 * Verifies the no-empty-pattern.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-empty-pattern.ts`.
 ...
 */
export const test_lint_rule_no_empty_pattern = (): void => {
  assertLintCase("no-empty-pattern.ts");
};
