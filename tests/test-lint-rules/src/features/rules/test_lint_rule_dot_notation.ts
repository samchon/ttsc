...
/**
 * Verifies the dot-notation.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/dot-notation.ts`.
 ...
 */
export const test_lint_rule_dot_notation = (): void => {
  assertLintCase("dot-notation.ts");
};
