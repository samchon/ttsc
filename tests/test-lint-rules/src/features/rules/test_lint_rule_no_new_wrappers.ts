...
/**
 * Verifies the no-new-wrappers.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-new-wrappers.ts`.
 ...
 */
export const test_lint_rule_no_new_wrappers = (): void => {
  assertLintCase("no-new-wrappers.ts");
};
