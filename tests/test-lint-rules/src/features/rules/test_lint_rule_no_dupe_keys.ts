...
/**
 * Verifies the no-dupe-keys.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-dupe-keys.ts`.
 ...
 */
export const test_lint_rule_no_dupe_keys = (): void => {
  assertLintCase("no-dupe-keys.ts");
};
