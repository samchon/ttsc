...
/**
 * Verifies the no-debugger.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-debugger.ts`.
 ...
 */
export const test_lint_rule_no_debugger = (): void => {
  assertLintCase("no-debugger.ts");
};
