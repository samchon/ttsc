...
/**
 * Verifies the no-fallthrough.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-fallthrough.ts`.
 ...
 */
export const test_lint_rule_no_fallthrough = (): void => {
  assertLintCase("no-fallthrough.ts");
};
