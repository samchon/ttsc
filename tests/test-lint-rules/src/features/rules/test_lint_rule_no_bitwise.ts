...
/**
 * Verifies the no-bitwise.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-bitwise.ts`.
 ...
 */
export const test_lint_rule_no_bitwise = (): void => {
  assertLintCase("no-bitwise.ts");
};
