...
/**
 * Verifies the no-empty-interface.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-empty-interface.ts`.
 ...
 */
export const test_lint_rule_no_empty_interface = (): void => {
  assertLintCase("no-empty-interface.ts");
};
