...
/**
 * Verifies the no-extra-non-null-assertion.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-extra-non-null-assertion.ts`.
 ...
 */
export const test_lint_rule_no_extra_non_null_assertion = (): void => {
  assertLintCase("no-extra-non-null-assertion.ts");
};
