...
/**
 * Verifies the prefer-const.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/prefer-const.ts`.
 ...
 */
export const test_lint_rule_prefer_const = (): void => {
  assertLintCase("prefer-const.ts");
};
