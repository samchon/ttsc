...
/**
 * Verifies the no-labels.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-labels.ts`.
 ...
 */
export const test_lint_rule_no_labels = (): void => {
  assertLintCase("no-labels.ts");
};
