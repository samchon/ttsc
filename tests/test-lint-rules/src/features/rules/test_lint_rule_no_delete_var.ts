...
/**
 * Verifies the no-delete-var.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-delete-var.ts`.
 ...
 */
export const test_lint_rule_no_delete_var = (): void => {
  assertLintCase("no-delete-var.ts");
};
