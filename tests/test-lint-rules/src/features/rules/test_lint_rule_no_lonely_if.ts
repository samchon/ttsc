...
/**
 * Verifies the no-lonely-if.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-lonely-if.ts`.
 ...
 */
export const test_lint_rule_no_lonely_if = (): void => {
  assertLintCase("no-lonely-if.ts");
};
