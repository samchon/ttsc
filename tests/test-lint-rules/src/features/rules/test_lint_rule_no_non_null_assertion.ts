...
/**
 * Verifies the no-non-null-assertion.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-non-null-assertion.ts`.
 ...
 */
export const test_lint_rule_no_non_null_assertion = (): void => {
  assertLintCase("no-non-null-assertion.ts");
};
