...
/**
 * Verifies the valid-typeof.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/valid-typeof.ts`.
 ...
 */
export const test_lint_rule_valid_typeof = (): void => {
  assertLintCase("valid-typeof.ts");
};
