...
/**
 * Verifies the no-return-assign.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-return-assign.ts`.
 ...
 */
export const test_lint_rule_no_return_assign = (): void => {
  assertLintCase("no-return-assign.ts");
};
