...
/**
 * Verifies the no-compare-neg-zero.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-compare-neg-zero.ts`.
 ...
 */
export const test_lint_rule_no_compare_neg_zero = (): void => {
  assertLintCase("no-compare-neg-zero.ts");
};
