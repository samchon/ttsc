...
/**
 * Verifies the no-empty-static-block.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-empty-static-block.ts`.
 ...
 */
export const test_lint_rule_no_empty_static_block = (): void => {
  assertLintCase("no-empty-static-block.ts");
};
