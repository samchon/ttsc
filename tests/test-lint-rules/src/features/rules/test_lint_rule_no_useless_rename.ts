...
/**
 * Verifies the no-useless-rename.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-useless-rename.ts`.
 ...
 */
export const test_lint_rule_no_useless_rename = (): void => {
  assertLintCase("no-useless-rename.ts");
};
