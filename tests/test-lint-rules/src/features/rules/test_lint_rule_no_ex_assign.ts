...
/**
 * Verifies the no-ex-assign.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-ex-assign.ts`.
 ...
 */
export const test_lint_rule_no_ex_assign = (): void => {
  assertLintCase("no-ex-assign.ts");
};
