...
/**
 * Verifies the no-non-null-asserted-nullish-coalescing.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-non-null-asserted-nullish-coalescing.ts`.
 ...
 */
export const test_lint_rule_no_non_null_asserted_nullish_coalescing =
  (): void => {
    assertLintCase("no-non-null-asserted-nullish-coalescing.ts");
  };
