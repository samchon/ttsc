...
/**
 * Verifies the prefer-exponentiation-operator.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/prefer-exponentiation-operator.ts`.
 ...
 */
export const test_lint_rule_prefer_exponentiation_operator = (): void => {
  assertLintCase("prefer-exponentiation-operator.ts");
};
