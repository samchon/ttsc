...
/**
 * Verifies the no-throw-literal.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-throw-literal.ts`.
 ...
 */
export const test_lint_rule_no_throw_literal = (): void => {
  assertLintCase("no-throw-literal.ts");
};
