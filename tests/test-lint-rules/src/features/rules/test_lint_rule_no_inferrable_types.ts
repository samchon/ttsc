...
/**
 * Verifies the no-inferrable-types.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-inferrable-types.ts`.
 ...
 */
export const test_lint_rule_no_inferrable_types = (): void => {
  assertLintCase("no-inferrable-types.ts");
};
