...
/**
 * Verifies the no-namespace.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-namespace.ts`.
 ...
 */
export const test_lint_rule_no_namespace = (): void => {
  assertLintCase("no-namespace.ts");
};
