...
/**
 * Verifies the no-dynamic-delete.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-dynamic-delete.ts`.
 ...
 */
export const test_lint_rule_no_dynamic_delete = (): void => {
  assertLintCase("no-dynamic-delete.ts");
};
