...
/**
 * Verifies the no-useless-computed-key.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-useless-computed-key.ts`.
 ...
 */
export const test_lint_rule_no_useless_computed_key = (): void => {
  assertLintCase("no-useless-computed-key.ts");
};
