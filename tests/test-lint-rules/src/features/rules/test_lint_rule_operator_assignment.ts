...
/**
 * Verifies the operator-assignment.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/operator-assignment.ts`.
 ...
 */
export const test_lint_rule_operator_assignment = (): void => {
  assertLintCase("operator-assignment.ts");
};
