...
/**
 * Verifies the no-plusplus.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-plusplus.ts`.
 ...
 */
export const test_lint_rule_no_plusplus = (): void => {
  assertLintCase("no-plusplus.ts");
};
