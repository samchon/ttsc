...
/**
 * Verifies the no-array-constructor.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-array-constructor.ts`.
 ...
 */
export const test_lint_rule_no_array_constructor = (): void => {
  assertLintCase("no-array-constructor.ts");
};
