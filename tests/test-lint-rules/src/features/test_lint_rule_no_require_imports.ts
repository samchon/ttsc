...
/**
 * Verifies the no-require-imports.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-require-imports.ts`.
 ...
 */
export const test_lint_rule_no_require_imports = (): void => {
  assertLintCase("no-require-imports.ts");
};
