...
/**
 * Verifies the no-object-constructor.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-object-constructor.ts`.
 ...
 */
export const test_lint_rule_no_object_constructor = (): void => {
  assertLintCase("no-object-constructor.ts");
};
