...
/**
 * Verifies the no-sparse-arrays.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-sparse-arrays.ts`.
 ...
 */
export const test_lint_rule_no_sparse_arrays = (): void => {
  assertLintCase("no-sparse-arrays.ts");
};
