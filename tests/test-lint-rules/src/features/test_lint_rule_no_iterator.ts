...
/**
 * Verifies the no-iterator.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-iterator.ts`.
 ...
 */
export const test_lint_rule_no_iterator = (): void => {
  assertLintCase("no-iterator.ts");
};
