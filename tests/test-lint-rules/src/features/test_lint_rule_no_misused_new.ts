...
/**
 * Verifies the no-misused-new.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-misused-new.ts`.
 ...
 */
export const test_lint_rule_no_misused_new = (): void => {
  assertLintCase("no-misused-new.ts");
};
