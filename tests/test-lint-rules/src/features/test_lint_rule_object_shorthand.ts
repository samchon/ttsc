...
/**
 * Verifies the object-shorthand.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/object-shorthand.ts`.
 ...
 */
export const test_lint_rule_object_shorthand = (): void => {
  assertLintCase("object-shorthand.ts");
};
