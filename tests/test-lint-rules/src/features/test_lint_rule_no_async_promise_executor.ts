...
/**
 * Verifies the no-async-promise-executor.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-async-promise-executor.ts`.
 ...
 */
export const test_lint_rule_no_async_promise_executor = (): void => {
  assertLintCase("no-async-promise-executor.ts");
};
