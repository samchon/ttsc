...
/**
 * Verifies the no-explicit-any.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-explicit-any.ts`.
 ...
 */
export const test_lint_rule_no_explicit_any = (): void => {
  assertLintCase("no-explicit-any.ts");
};
