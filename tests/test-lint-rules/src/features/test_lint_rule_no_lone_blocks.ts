...
/**
 * Verifies the no-lone-blocks.ts lint fixture.
 *
 ...
 *
 * 1. Read the fixture from `src/cases/no-lone-blocks.ts`.
 ...
 */
export const test_lint_rule_no_lone_blocks = (): void => {
  assertLintCase("no-lone-blocks.ts");
};
