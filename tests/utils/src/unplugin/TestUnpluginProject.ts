  ...
  export function writeGoPlugin(root: string): void {
    ...
    fs.writeFileSync(
      ...
      [
        ...
        "  if err != nil { fmt.Fprintln(os.Stderr, err); return 2 }",
        '  data, err := json.Marshal(transformResult{TypeScript: map[string]string{"src/main.ts": code}, Dependencies: collectedDependencies, Graph: collectedGraph, Volatile: collectedVolatile})',
        "  if err != nil { fmt.Fprintln(os.Stderr, err); return 2 }",
