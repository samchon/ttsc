 ...
 * 3. Assert each payload leads with `integrity`, holds only the facts and their
 *    disposition, and arrives as structured content alone.
 */
export const test_ttscgraph_reports_audited_integrity_before_the_facts =
  async () => {
