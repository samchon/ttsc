 ...
 * syntax. Import/export/require lookalikes inside comments, string and
 * template contents, and regex literals are inert text and must never become
 ...
 * 2. Boundary: `obj.require(...)`, unresolvable template specifiers, scoped
 *    names, subpaths, built-ins, relative paths, and duplicates behave per the
 ...
 */
export const test_collect_external_package_names_ignores_non_code = async () => {
  const mixed = [
