import { assert, fs, loadProjectPlugins, os, path } from "../internal/project";

/**
 * Verifies loadProjectPlugins suppresses package auto plugin through symlinked explicit path.
 *
