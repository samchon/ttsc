 ...
 * resolve hook must probe the directory-index candidates, then redirect the
 * resolved `sub/index.ts` to the JavaScript tsgo emitted for the package (whose
 * immediate directory has no `package.json`, exercising the walk to the package
 * root).
 *
