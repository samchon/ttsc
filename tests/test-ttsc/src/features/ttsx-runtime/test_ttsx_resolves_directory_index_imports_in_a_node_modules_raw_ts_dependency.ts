 ...
 * resolve hook must probe the directory-index candidates and resolve to the
 * source `sub/index.ts`, which `load` then serves as the JavaScript tsgo
 * emitted for the package (whose immediate directory has no `package.json`,
 * exercising the walk to the package root).
 *
