...
declaration with its file and line, and the call, type, heritage, and route
relationships between them, all resolved by the compiler — not guessed. Query it
before grep or read; it has already located the symbols and connected them.
...
- graph_trace: follow flow from a symbol or route — forward to what it uses,
...
Every relationship carries a provenance (checker-resolved, framework-derived, or
heuristic) and confidence; treat framework and heuristic edges as inferred. The
