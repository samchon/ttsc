...
A constructor parameter carrying `public`, `readonly`, `private`, or `protected` declares a field, and it classifies exactly as the same field written in the class body would.
