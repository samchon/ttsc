...
// from `FLAG_SCHEMA.ts` — see `scripts/check-flags.cjs`.
...
import type { FlagLayer } from "../src/flags/FlagLayer.ts";
import type { FlagSpec } from "../src/flags/FlagSpec.ts";
import { buildGoAllowList } from "../src/flags/buildGoAllowList.ts";
...
//
// Source of truth: packages/ttsc/src/flags/FLAG_SCHEMA.ts.
...
//
// Generated from packages/ttsc/src/flags/FLAG_SCHEMA.ts. Edit the schema, not
// this file.
...
Single source of truth: \`packages/ttsc/src/flags/FLAG_SCHEMA.ts\`. Each row is one
