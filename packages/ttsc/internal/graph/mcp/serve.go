...
// maxMessageBytes caps a single JSON-RPC line. Tool results are structured and
// bounded, but expanded source and large diagnostic batches can exceed the
// default 64 KB scanner token.
