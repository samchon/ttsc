 ...
 * marker, so readers across processes see either a complete old generation or
 * a complete new one.
 */
...
export function dependencyGenerationDir(cacheDir: string, generation: string): string {
