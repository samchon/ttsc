...
/**
 * Write the language server's plugin manifest to a private file the Go host
 * can read.
 *
 ...
 * second server or another user on the machine can neither read nor replace
 * the selection this server made.
 */
