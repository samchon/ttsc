 ...
 * path itself when absolute or qualified, otherwise each `PATH` directory.
 * On Windows the current directory is searched first, as process creation
 * does, unless `NoDefaultCurrentDirectoryInExePath` is set.
 */
