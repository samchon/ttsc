...
export function collectNearestPackageJsonCandidates(location: string): string[] {
 ...
 */
export function readPackageManifest(file: string): PackageManifest | undefined {
 ...
 */
export function resolvePluginRequest(specifier: string, projectRoot: string): string {
