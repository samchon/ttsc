...
// TestRunDeclaresTheCapabilityItsOutputCarries verifies that this command's own
// output declares the documentation-tag capability, and that a project carrying
// no tag emits the field nowhere.
//
...
//  2. Assert the capability is declared and the tag reached the output.
