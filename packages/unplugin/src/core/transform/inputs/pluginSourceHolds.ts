 ...
 * the adapter refute the output its own compiler just produced. A directory a
 * file below could not be read from proves nothing.
 *
 ...
 */
export function pluginSourceHolds(directory: string, state: string): boolean {
  try {
