...
Transform source outputs outside the project walk are kept in that external snapshot too. Their source hashes let sibling module requests validate the same generation without adding arbitrary output keys to the project-file universe.
